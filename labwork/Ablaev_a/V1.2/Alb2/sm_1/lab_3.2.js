        ...
        str3 =  '<table class="table table-bordered table-condensed">\
                    <tbody>\
                        <tr><td><h4><b2>Фамилия</b2></h4></td>\
                            <td><input type="text" value="Аблаев" class="input_vvod" id="id_lab_3_2_ex_1_surname"></td></tr>\
                        <tr><td><h4><b2>Имя</b2></h4></td>\
                            <td><input type="text" value="Артур" class="input_vvod" id="id_lab_3_2_ex_1_name"></td></tr>\
                        <tr><td><h4><b2>Отчество</b2></h4></td>\
                            <td><input type="text" value="Зинурович" class="input_vvod" id="id_lab_3_2_ex_1_patronymic"></td></tr>\
                        </tbody>\
                </table>\

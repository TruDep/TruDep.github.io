        ...
        str3 = '<table class="table table-bordered table-condensed">\
                <tbody>\
                    <tr><td><h4><b2>FirstName</b2></h4></td>\
                        <td><input type="text" value="Роман" class="input_vvod" id="id_lab_18_ex_2_FN"></td></tr>\
                    <tr><td><h4><b2>SecondName</b2></h4></td>\
                        <td><input type="text" value="Мартыненко" class="input_vvod" id="id_lab_18_ex_2_SN"></td></tr>\
                    </tbody>\
                 </table>\
